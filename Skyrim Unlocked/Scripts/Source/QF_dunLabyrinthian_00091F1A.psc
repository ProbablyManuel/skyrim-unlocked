...
If (Alias_MG07Staff.GetReference())
	Alias_Morokei.GetActorReference().EquipItem(Alias_MG07Staff.GetReference(), True)
Else
	Alias_Morokei.GetActorReference().EquipItem(MG07StaffOfMagnus, True)
EndIf
utility.wait(5.0)
