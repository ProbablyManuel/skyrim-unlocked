...
if Game.GetPlayer().GetItemCount(Alias_Book.GetRef())
;the player already has the Jagged Crown
SetStage(180)
else
...
if Game.GetPlayer().GetItemCount(Alias_Book.GetRef()) == 0
...
;MQ104A.setstage(10)
kmyquest.CW03.setstage(10) ;USKP 2.1.3 Bug #19407
;END CODE
EndFunction
;END FRAGMENT
...
KorvanjundReserved.Clear()
kmyquest.CW03.setstage(10) ;USKP 2.1.3 Bug #19407
CW01AOutfitImperial.FailAllObjectives() ;USKP 2.1.3 Bug #19402
CW01AOutfitImperial.Stop()
RalofRef.AddItem(RalofWarhammer, 1) ;USLEEP 3.0.3 Bug #19974
RalofRef.SetOutfit(RalofOutfit) ;USLEEP 3.0.3 Bug #19974
;END CODE
EndFunction
;END FRAGMENT
...
Quest Property CW01AOutfitImperial Auto ;USKP 2.1.3 Bug #19402
Actor Property RalofRef Auto ;USLEEP 3.0.3 Bug #19974
Outfit Property RalofOutfit Auto ;USLEEP 3.0.3 Bug #19974
Weapon Property RalofWarhammer Auto ;USLEEP 3.0.3 Bug #19974
